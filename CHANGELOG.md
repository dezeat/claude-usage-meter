...
* cross-session limits sync + H3 read indexes (schema v3) ([8bd5961](https://github.com/dezeat/claude-usage-meter/commit/8bd5961c2c719ddb769be3b1cc5a26ac2100b93e))
...
* debounce the hot-path sweep behind a per-claudeDir mtime watermark ([b509b35](https://github.com/dezeat/claude-usage-meter/commit/b509b353a1a33167cbbf51680a35557f41e9047c))
...
* spend row splits the token trail as i|c|o (ADR-0005) ([228acdb](https://github.com/dezeat/claude-usage-meter/commit/228acdbc138f492d266984ca5dc864b50a566360))
...
* bump the marketplace manifest version in the release PR ([ec9014f](https://github.com/dezeat/claude-usage-meter/commit/ec9014f87d1c525fe590ebc1d99f2b0d316e7f0e))
* countdown never renders a zero unit — d/h/m appear only when at least one remains ([2c68020](https://github.com/dezeat/claude-usage-meter/commit/2c680207eb4251fa1516c00209585bbb4ce3c150))
...
* countdown shows only its largest time unit ([16c6ed9](https://github.com/dezeat/claude-usage-meter/commit/16c6ed9e8b5eada23c2bcbcc09c598ab82a41a21))
...
* unify the cost-forward ses cell and centralize formatUsd ([4032dc6](https://github.com/dezeat/claude-usage-meter/commit/4032dc6580ff448910378557526ad6215dba8429))
...
* ADR-0005 spend-row token vocabulary (i|c|o, cache writes count as input) ([bd8319c](https://github.com/dezeat/claude-usage-meter/commit/bd8319cf75e287939a7303ce3331befe0b6e8fa8))
...
* in-repo C4 architecture diagram (hand-drawn) + diagramming skill ([ba148f8](https://github.com/dezeat/claude-usage-meter/commit/ba148f8c3d99411dbeba00c2860e5ad2941e1db2))
...
* polish README for v0.1.0 (bulleted rows, leaner Install, architecture link) ([81e9da7](https://github.com/dezeat/claude-usage-meter/commit/81e9da77117f1d6a6d0af44017c87e42ff2fe1ee))
...
* refresh hero statusline.svg to current rendering ([4a29a65](https://github.com/dezeat/claude-usage-meter/commit/4a29a65e65e49e000fa0f21d1e97992f4ff22d31))
