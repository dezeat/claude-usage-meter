...
export interface SessionHeartbeat {
  ...
  // The active session's model class off its own payload. Rides the heartbeat so a
  // session surfaced before its transcript folds names itself in the roster instead
  // of "unknown". Null/omitted when the payload has no usable model.
